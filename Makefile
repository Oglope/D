all:
	...
	gcc 1.o bin_sem.o -lpthread -lm -o 1
	gcc 2.o bin_sem.o -lpthread -lm -o 2
	gcc 8.o bin_sem.o -lpthread -lm -o 8
	gcc 9.o bin_sem.o -lpthread -lm -o 9
	gcc 10.o bin_sem.o -lpthread -lm -o 10
